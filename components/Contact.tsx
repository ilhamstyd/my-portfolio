  ...
  return (
    ...
    >
      ...
      <p className="max-w-[600px] text-center text-textDark">
        I'm looking for a new job and would really appreciate your help, If you
        have any job openings or would like to offer me a job, my inbox is
        always open or you have any questions or just want to say hi, I'll do my
